...
public interface ShowtimeRepository extends JpaRepository<Showtime, Long>, JpaSpecificationExecutor<Showtime> {
    ...
    // Basic finders
    List<Showtime> findByCinema_Id(Long cinemaId);
    List<Showtime> findByMovieTitleIgnoreCaseContaining(String query);
    List<Showtime> findByCinema_IdAndStartTimeBetween(Long cinemaId, LocalDateTime from, LocalDateTime to);
